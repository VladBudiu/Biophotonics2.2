...
def compare_models():
    ...
    for model_name, model in models.items():
        ...
        # Show 2D visualization for a specific depth
        print(f"Visualizing 2D energy projection for {model_name}...")
        viewer.show2D(View2DSliceZ(position=0.15))

        # Show 1D visualization for energy profile
        print(f"Visualizing 1D energy profile for {model_name}...")
